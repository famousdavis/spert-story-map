...
import {
  cleanCardOrder, addNamedRibToProduct, splitRibInProduct, cloneRibInProduct,
 ...
 *
 * Pure (prev: Product) => Product transforms used here (cleanCardOrder,
 * addNamedRibToProduct, splitRibInProduct, cloneRibInProduct) live in
 * productTransforms.ts and are shared with the AI op applier (aiOps.ts).
 */
