 ...
 */
export async function isTosAcceptedInFirestore(uid: string): Promise<boolean> {
 ...
 */
export async function writeTosAcceptance(uid: string, authProvider: string): Promise<void> {
  if (!db || !uid) return;
  ...
  try {
    ...
    // eslint-disable-next-line @typescript-eslint/no-explicit-any -- ToS document fields vary by acceptance state
