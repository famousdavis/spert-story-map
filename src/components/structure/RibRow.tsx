...
import type { RibItem, SizeMapping } from '../../types';
...
interface RibRowProps {
  ...
  onDragStart: (themeId: string, backboneId: string, ribId: string) => void;
  onDragEnd: () => void;
  onDragOver: (e: React.DragEvent, ribId: string) => void;
  onRename: (themeId: string, backboneId: string, ribId: string, updates: Record<string, unknown>) => void;
  onDelete: (themeId: string, backboneId: string, ribId: string, name: string) => void;
}
