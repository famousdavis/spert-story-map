...
function spliceCardOrder(cardOrder: Record<string, string[]>, key: string, ribId: string, insertIndex: number | null): void {
 ...
 */
function spliceCardOrderByColumn(cardOrder: Record<string, string[]>, key: string, ribId: string, insertIndex: number | null, columnRibIds: Set<string> | null): void {
  const list = [...(cardOrder[key] || [])].filter(id => id !== ribId);
 ...
 */
export function transferAllocation(rib: RibItem, fromReleaseId: string | null, toReleaseId: string | null): ReleaseAllocation[] | null {
  if (toReleaseId === null) {
...
function applyAllocationTransfer(themes: Theme[], ribId: string, fromReleaseId: string | null, toReleaseId: string | null): Theme[] {
  return themes.map(t => ({
    ...t,
    backboneItems: t.backboneItems.map(b => ({
      ...b,
 ...
 */
export function moveRibToRelease(updateProduct: UpdateProduct, ribId: string, fromReleaseId: string | null, toReleaseId: string | null, insertIndex: number | null): void {
  updateProduct(prev => {
    const next = {
      ...prev,
 ...
 */
export function reorderRibInRelease(updateProduct: UpdateProduct, ribId: string, releaseId: string | null, insertIndex: number | null, backboneId: string): void {
  updateProduct(prev => {
 ...
 */
export function moveRibToBackbone(updateProduct: UpdateProduct, ribId: string, fromThemeId: string, fromBackboneId: string, toThemeId: string, toBackboneId: string): void {
  updateProduct(prev => {
 ...
 */
export function reorderTheme(updateProduct: UpdateProduct, themeId: string, insertIndex: number | null): void {
  updateProduct(prev => {
 ...
 */
export function moveRib2D(updateProduct: UpdateProduct, ribId: string, from: { themeId: string; backboneId: string; releaseId: string | null }, to: { themeId: string; backboneId: string; releaseId: string | null; insertIndex: number | null }): void {
 ...
 */
export function moveRibs2D(updateProduct: UpdateProduct, entries: { ribId: string; fromThemeId: string; fromBackboneId: string; fromReleaseId: string | null }[], to: { themeId: string; backboneId: string; releaseId: string | null; insertIndex: number | null }): void {
